          ...
          <div class="col-md-9">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Update Website Configuration</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" @submit.prevent = 'configEdit' enctype="multipart/form-data">
                <div class="card-body">
                    <div class="row">
...
export default {
  ...
  mounted(){
     ...
     created(){
        ...
        axios.get('/configById/'+this.$route.params.configId).then((response)=>{
            this.header_text = response.data.configById.header_text
            this.slogan_text = response.data.configById.slogan_text
            this.contact_email = response.data.configById.contact_email
            this.contact_mobile = response.data.configById.contact_mobile
            this.footer_text = response.data.configById.footer_text
  ...
  methods: {
    ...
    configEdit () {
     ...
     form.append('footer_text',this.footer_text);
       ...
       axios.post(`/configUpdate/${this.$route.params.configId}`,form)
        .then((response) => {
